...
#Start of funcitonal area
#Allows building standalone items and adding them to the main document.

def create_table(table: list, has_headers: bool=True, has_footers:bool =True, headers:list =[], footers:list =[]):
    return tb.create_table(table, has_headers, has_footers, headers, footers)
